...
QT_MOC_LITERAL(1, 13, 16), // "newMessagePosted"
QT_MOC_LITERAL(2, 30, 0), // ""
QT_MOC_LITERAL(3, 31, 7), // "subject"
QT_MOC_LITERAL(4, 39, 7), // "refresh"
QT_MOC_LITERAL(5, 47, 12), // "triggerEvent"
QT_MOC_LITERAL(6, 60, 4), // "text"
QT_MOC_LITERAL(7, 65, 11), // "postMessage"
QT_MOC_LITERAL(8, 77, 3) // "msg"

    },
    "MessageBoard\0newMessagePosted\0\0subject\0"
    "refresh\0triggerEvent\0text\0postMessage\0"
    "msg"
};
...
void MessageBoard::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->triggerEvent((*reinterpret_cast< QString(*)>(_a[1]))); break;
        ...
        {
            using _t = void (MessageBoard::*)(const QString & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MessageBoard::newMessagePosted)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void MessageBoard::newMessagePosted(const QString & _t1)
{
